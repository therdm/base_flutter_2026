...
class InternetConnectionManager {
  ...
  void initialize() {
    listener((bool internetStatus) {
      final wasConnected = _isInternetConnected.value;
      if (internetStatus) {
      ...
      if (wasConnected != _isInternetConnected.value) {
        _connectionStreamController.add(_isInternetConnected.value);
      }
    });
  }
  ...
  void rawListener(
    void Function(List<ConnectivityResult>)? onConnection, {
    Function? onError,
    void Function()? onDone,
    bool? cancelOnError,
  }) {
