...
import 'package:services/data_providers/remote_authentication.dart';
...
class RestApi implements IRestApi {
  ...
  Future<Map<String, dynamic>> getHeader() async {
    return RemoteAuthentication.instance.getHeader(_tokenKeyName);
  }
  ...
  void _apiLog(
    ...
    if (!kIsWeb && _showApiLog) {
      ...
      apiCallDetails =
          '${apiCallDetails}HEADERS » ${LogMaster.prettyJson(header ?? dio.options.headers)}\n$separator';
      if (body is! FormData && body != <Map<String, String>>{}) {
  ...
  Future<Response<dynamic>> _restApi(
    ...
    try {
      ...
      //   );
      // }
      // TODO(Rahul): To be asked to Apurba why it was there.
